...
public class JobConf extends Configuration {
  ...
  // COS518 Edition
  /**
   * Set the field MELBOURNE_KEY to be the user-supplied
   * secret key for the job
   */
  public void setMelbourneShuffleKey(int secret_key) {
    setInt(JobContext.MELBOURNE_KEY, secret_key); // see mapreduce.MRJobConfig
  }
  ...
  // COS518 Edition
  /**
   * Get the user-supplied secret key for melbourne shuffle
   * Defaults to 0
   * 
   * @return the secret key (an integer)
   */
  public int getMelbourneKey() { return getInt(JobContext.MELBOURNE_KEY, 0); }; // see mapreduce.MRJobConfig 
